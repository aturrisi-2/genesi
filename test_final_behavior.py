#!/usr/bin/env python3
"""
TEST FINALE COMPORTAMENTO GENESI
Simula i casi reali segnalati dall'utente
"""
...
def test_real_world_scenarios():
    ...
    try:
        ...
        creative_inputs = [
            ...
            "Hello! 😊 How are you?",
            "*giggle* Oh bella! *esprime entusiasmo*",
            "February is cold *adjusts sunglasses*"
        ]
        
        for creative_input in creative_inputs:
            filtered = post_llm_filter.filter_response(creative_input)
            has_issues = "*" in filtered or "😊" in filtered or "hello" in filtered.lower()

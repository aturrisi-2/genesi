...
async def start_wizard(user_id: str, platform: str) -> str:
    ...
    prompt = (
        ...
        "Se devi chiedere qualcosa che l'utente potrebbe non capire (es. 'Come chiamo la tua App su Facebook?'), "
        "SPIEGALO BREVEMENTE IN MODO SEMPLICE (es. 'Ho bisogno di dare un nome al collegamento che sto creando su Facebook. Come lo vogliamo chiamare? Va bene Genesi?').\n"

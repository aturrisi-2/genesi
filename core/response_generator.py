        ...
        # Carattere SOLO per risposte relazionali
            ...
            if question_rate == 0.0:
                ...
                final_prompt = (
                    ...
                    "\n"
                    "GENESI deve:\n"
                    "- formulare una risposta specifica e situata\n"
                    "- basarsi esclusivamente sulle informazioni disponibili\n"
                    "- proporre un'azione semplice, realistica, non prescrittiva\n"
                    "- usare un tono sobrio, diretto, umano\n"
                    "- evitare consolazioni automatiche\n"
                    "- evitare ritirate o deleghe della decisione\n"
                    "\n"
                    "GENESI può essere breve,\n"
                    "ma ogni risposta deve contenere un'informazione, un orientamento o un punto fermo.\n\n"
                    + final_prompt
                )
            else:
                final_prompt = (

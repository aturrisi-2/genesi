...
_TEMPORAL = {
    ...
    "ultimo studio", "nuovi studi", "prossim", "futur",
    "oggi", "ieri", "stanotte", "stamattina",
...
_CURRENT_EVENTS = {
    ...
    "formula 1", "formula uno", "gran premio", "granpremio", "f1", "motogp", "gara di formula",
    "dove corrono", "dove si corre", "dove giocano", "dove si gioca",
    "dove si svolge", "dove si disputa", "calendario f1", "calendario",
    "piloti di formula", "circuito di", "gara di domenica", "chi corre",

...
memory_engine.update_profile(user_id, "profession", "Pilota")
memory_engine.update_profile(user_id, "profession", "Ingegnere")  # Update profession
memory_engine.update_relational(user_id, "spouse", "Elena")
...
assert context['memory_v2']['relational']['spouse'] == "Elena", "Spouse mismatch in memory V2"
